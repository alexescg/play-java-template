...
public class Signup extends Controller {
    ...
    public Result verify(final String token) {
        ...
        final long unverifiedUserId = ta.targetUser.id;
        Optional<User> unverifiedUser = User.findById(unverifiedUserId);
        ...
        User.verify(user);
        flash(Application.FLASH_MESSAGE_KEY,
                this.msg.preferred(request()).at("playauthenticate.verify_email.success", user.email));
